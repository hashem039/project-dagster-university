...
def taxi_trips_file(context: dg.AssetExecutionContext) -> None:
    ...
    """
    partion_date_str = context.partition_key
    month_to_fetch = partion_date_str[:-3]
...
def taxi_zones_file() -> None:
    ...
    with open(constants.TAXI_ZONES_FILE_PATH, mode="wb") as output_file:
...
def taxi_trips(context: dg.AssetExecutionContext,database: DuckDBResource) -> None:
    """
    The raw taxi trips dataset, loaded into a DuckDB databse
    """
